...
import { configSchemaV3 } from './schema.js'

export const CONFIG_JSON_SCHEMA_TITLE = 'wrkrs configuration (schema version 3)'
...
export function generateConfigJsonSchema(): Record<string, unknown> {
  const generated = z.toJSONSchema(configSchemaV3, { io: 'input', target: 'draft-2020-12' })
